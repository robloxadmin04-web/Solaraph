...
local Config = setmetatable({
    save = function(self: any, file_name: any, config: any)
        local success_save, result = pcall(function()
            ...
            writefile('eHplcm8/'..file_name..'.json', flags)
        end)
    ...
    load = function(self: any, file_name: any, config: any)
        local success_load, result = pcall(function()
            if not isfile('eHplcm8/'..file_name..'.json') then
                self:save(file_name, config)
        
                return
            end
        
            local flags = readfile('eHplcm8/'..file_name..'.json')
...
function Library:create_notification_root()
    ...
    local root = CoreGui:FindFirstChild('eHplcm8NotificationRoot')
    ...
    notification_root.Name = 'eHplcm8NotificationRoot'
...
function Library:create_ui()
    local old_eHplcm8 = CoreGui:FindFirstChild('eHplcm8')

    if old_eHplcm8 then
        Debris:AddItem(old_eHplcm8, 0)
    end

    local eHplcm8UI = Instance.new('ScreenGui')
    eHplcm8UI.ResetOnSpawn = false
    eHplcm8UI.Name = 'eHplcm8'
    eHplcm8UI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    eHplcm8UI.Parent = CoreGui
    ...
    Container.ZIndex = 2
    Container.Parent = eHplcm8UI


    local function set_gui_visibility(state: boolean)
        eHplcm8UI.Enabled = state
    ...
    Tabs.BackgroundColor3 = Color3.fromRGB(12, 12, 14)
    ...
    ClientName.Text = 'eHplcm8'
    ClientName.Name = 'ClientName'
    ClientName.Size = UDim2.new(0, 90, 0, 13)
    ...
    ClientNameGradient.Name = 'ShimmerGradient'
    ...
    ClientNameGradient.Rotation = 0
    ClientNameGradient.Offset = Vector2.new(-1, 0)
    ClientNameGradient.Parent = ClientName

    local ClientNameStroke = Instance.new('UIStroke')
    ClientNameStroke.Name = 'GlowStroke'
    ClientNameStroke.Color = Color3.fromRGB(255, 255, 255)
    ClientNameStroke.Thickness = 1
    ClientNameStroke.Transparency = 0.6
    ClientNameStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Contextual
    ClientNameStroke.Parent = ClientName
    ...
    task.spawn(function()
        while ClientNameStroke and ClientNameStroke.Parent do
    ...
    ModePill.BackgroundColor3 = Color3.fromRGB(24, 24, 26)
    ModePill.BackgroundTransparency = 0.05
    ModePill.BorderSizePixel = 0
    ModePill.Size = UDim2.new(0, 168, 0, 28)
    ModePill.AnchorPoint = Vector2.new(1, 0.5)
    ModePill.Position = UDim2.new(1, -8, 0.029, 16)
    ModePill.Parent = Handler

    local ModePillCorner = Instance.new('UICorner')
    ModePillCorner.CornerRadius = UDim.new(1, 0)
    ModePillCorner.Parent = ModePill

    local ModePillStroke = Instance.new('UIStroke')
    ModePillStroke.Color = Color3.fromRGB(80, 80, 82)
    ModePillStroke.Thickness = 1
    ModePillStroke.Transparency = 0.4
    ModePillStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    ModePillStroke.Parent = ModePill

    local BasicButton = Instance.new('TextButton')
    BasicButton.Name = 'BasicButton'
    BasicButton.AutoButtonColor = false
    BasicButton.BackgroundColor3 = Color3.fromRGB(240, 240, 240)
    BasicButton.BackgroundTransparency = 0
    BasicButton.BorderSizePixel = 0
    BasicButton.Size = UDim2.new(0, 74, 0, 22)
    BasicButton.AnchorPoint = Vector2.new(0, 0.5)
    BasicButton.Position = UDim2.new(0, 3, 0.5, 0)
    BasicButton.FontFace = Font.new('rbxasset://fonts/families/GothamSSm.json', Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BasicButton.Text = 'Basic'
    BasicButton.TextColor3 = Color3.fromRGB(20, 20, 20)
    BasicButton.TextSize = 12
    BasicButton.Parent = ModePill

    local BasicCorner = Instance.new('UICorner')
    BasicCorner.CornerRadius = UDim.new(1, 0)
    ...
    BasicGradient.Parent = BasicButton

    local Divider = Instance.new('TextLabel')
    Divider.Name = 'ModeDivider'
    Divider.BackgroundTransparency = 1
    Divider.AnchorPoint = Vector2.new(0.5, 0.5)
    Divider.Position = UDim2.new(0.5, 0, 0.5, 0)
    Divider.Size = UDim2.new(0, 10, 0, 22)
    Divider.FontFace = Font.new('rbxasset://fonts/families/GothamSSm.json', Enum.FontWeight.Medium, Enum.FontStyle.Normal)
    Divider.Text = '/'
    Divider.TextColor3 = Color3.fromRGB(160, 160, 162)
    Divider.TextSize = 14
    Divider.Parent = ModePill

    local AdvancedButton = Instance.new('TextButton')
    AdvancedButton.Name = 'AdvancedButton'
    AdvancedButton.AutoButtonColor = false
    AdvancedButton.BackgroundColor3 = Color3.fromRGB(38, 38, 40)
    AdvancedButton.BackgroundTransparency = 0
    AdvancedButton.BorderSizePixel = 0
    AdvancedButton.Size = UDim2.new(0, 74, 0, 22)
    AdvancedButton.AnchorPoint = Vector2.new(1, 0.5)
    AdvancedButton.Position = UDim2.new(1, -3, 0.5, 0)
    AdvancedButton.FontFace = Font.new('rbxasset://fonts/families/GothamSSm.json', Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    AdvancedButton.Text = 'Advanced'
    AdvancedButton.TextColor3 = Color3.fromRGB(220, 220, 220)
    AdvancedButton.TextSize = 12
    AdvancedButton.Parent = ModePill

    local AdvancedCorner = Instance.new('UICorner')
    AdvancedCorner.CornerRadius = UDim.new(1, 0)
    ...
    AdvancedGradient.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(56, 56, 58)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(28, 28, 30))
    })
    AdvancedGradient.Rotation = 90
    AdvancedGradient.Parent = AdvancedButton
    ...
    local function apply_tab_mode(mode)
        local firstVisibleTab = nil

        for _, tabObj in ipairs(Tabs:GetChildren()) do
            if tabObj.Name == 'Tab' then
                local textLabel = tabObj:FindFirstChild('TextLabel')
                local tabTitle = textLabel and textLabel.Text or ''
                local shouldShow

                if mode == 'Basic' then
                    shouldShow = BASIC_ALLOWED[tabTitle] == true
                else
                    shouldShow = true
                end

                tabObj.Visible = shouldShow

                if shouldShow and not firstVisibleTab then
                    firstVisibleTab = tabObj
                end
            end
        end

        local activeTabIsHidden = true
        for _, tabObj in ipairs(Tabs:GetChildren()) do
            if tabObj.Name == 'Tab' and tabObj.Visible and tabObj:FindFirstChild('ActiveIndicator') then
                activeTabIsHidden = false
                break
            end
        end

        if activeTabIsHidden and firstVisibleTab then
            pcall(function()
                firstVisibleTab:FindFirstChildOfClass('TextButton')
            end)

            local clickSignal = firstVisibleTab.MouseButton1Click
            if clickSignal then
                pcall(function()
                    for _, conn in ipairs(getconnections and getconnections(clickSignal) or {}) do
        ...
        if mode == 'Basic' then
            ...
            AdvancedButton.BackgroundColor3 = Color3.fromRGB(240, 240, 240)
            AdvancedButton.TextColor3 = Color3.fromRGB(20, 20, 20)
            AdvancedGradient.Color = ColorSequence.new({
                ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
                ColorSequenceKeypoint.new(1, Color3.fromRGB(210, 210, 210))
            })
            BasicButton.BackgroundColor3 = Color3.fromRGB(38, 38, 40)
            BasicButton.TextColor3 = Color3.fromRGB(220, 220, 220)
            BasicGradient.Color = ColorSequence.new({
                ColorSequenceKeypoint.new(0, Color3.fromRGB(56, 56, 58)),
                ColorSequenceKeypoint.new(1, Color3.fromRGB(28, 28, 30))
            })
    ...
    function self:UIVisiblity()
        eHplcm8UI.Enabled = not eHplcm8UI.Enabled;
    end;
    ...
    function self:load()
        ...
        for _, object in eHplcm8UI:GetDescendants() do
...
function TabManager:moduleparagraph(settings: any)
    ...
    Module.BackgroundTransparency = 0.55
    ...
    if not settings.rich then
        ...
        ModuleName.Text = settings.richtext or "<font color='rgb(255,0,0)'>eHplcm8</font> Info"
    end
...
function TabManager:create_playerinfo(settings: any)
    ...
    Module.ClipsDescendants = true
    Module.BorderColor3 = Color3.fromRGB(0, 0, 0)
    Module.BackgroundTransparency = 0.65
    Module.Position = UDim2.new(0.004, 0, 0, 0)
    ...
    task.spawn(function()
        ...
        function TabManager:create_module(settings: any)
            ...
            do
                local _origPos = Module.Position
                local _origTrans = Module.BackgroundTransparency
                Module.Position = _origPos + UDim2.new(0, 0, 0, 12)
                ...
                task.spawn(function()
                    ...
                    TweenService:Create(
                        ...
                        { Position = _origPos, BackgroundTransparency = _origTrans }
                    ):Play()
                end)
            end
            ...
            if not settings.rich then
                ...
                ModuleName.RichText = true
                ModuleName.Text = settings.richtext or "<font color='rgb(255,0,0)'>eHplcm8</font> user"
            end;
            ModuleName.Name = 'ModuleName'
            ModuleName.Size = UDim2.new(0, 205, 0, 13)
            ModuleName.AnchorPoint = Vector2.new(0, 0.5)
            ...
            function ModuleManager:create_paragraph(settings: any)
                ...
                if not settings.rich then
                    ...
                    Body.RichText = true
                    Body.Text = settings.richtext or "<font color='rgb(255,0,0)'>eHplcm8</font> user"
                end
            ...
            function ModuleManager:create_text(settings: any)
                ...
                function TextManager:Set(new_settings)
                    if not new_settings.rich then
                        ...
                        Body.RichText = true
                        Body.Text = new_settings.richtext or "<font color='rgb(255,0,0)'>eHplcm8</font> user"
                    end
                end;
...
local ThemeTab = library:create_tab("Customization")


local guilib_module = MiscTab:create_module({
    title = "GUI Visible",
...
local stats_overlay_module = MiscTab:create_module({
    title = "FPS and Ping",
    ...
    callback = function(state)
        if state then
            ...
            if not System.__properties.__stats_overlay then
                ...
                OverlayGui.Name = 'eHplcm8StatsOverlay'
...
local filter_module = VisualsTab:create_module({
    title = 'Filter',
    flag = 'Filter',
...
local function show_manual_spam_warning_modal()
    ...
    gui.Name = 'eHplcm8ManualSpamWarning'
...
-- ═══════════════════════════════════════════════════════════════════
-- UNLOCK ALL MODULE (EXACT source port via loadstring + WindUI shims)
-- ═══════════════════════════════════════════════════════════════════

do
    local unlockAllStarted = false
    local unlock_all_module = VisualsTab:create_module({
        title = "Unlock All",
        description = "Sword & Explosions",
        flag = "UnlockAllModule",
        section = "left",
        callback = function(state)
            ...
            task.spawn(function()
                local ok, err = pcall(function()
                    ...
                    -- Shim: mimic WindUI/Window API para tumakbo ang source function nang walang LeviHub UI
                    local pendingToggles = {}

                    local ShimTab = {}
                    ShimTab.__index = ShimTab
                    function ShimTab:Section(opts) return self end
                    function ShimTab:Toggle(opts)
                        table.insert(pendingToggles, opts)
                        local wrapper = { __opts = opts, Value = opts.Value }
                        function wrapper:Set(v) self.Value = v; if opts.Callback then pcall(opts.Callback, v) end end
                        return wrapper
                    end
                    function ShimTab:Input(opts)
                        local wrapper = { __opts = opts, Value = opts.Value or "" }
                        function wrapper:Set(v) self.Value = v; if opts.Callback then pcall(opts.Callback, v) end end
                        return wrapper
                    end
                    function ShimTab:Button(opts) return { __opts = opts } end
                    function ShimTab:Paragraph(opts) return self end
                    function ShimTab:Divider() return self end
                    function ShimTab:Dropdown(opts)
                        local wrapper = { __opts = opts, Value = opts.Value }
                        function wrapper:Set(v) self.Value = v; if opts.Callback then pcall(opts.Callback, v) end end
                        function wrapper:Refresh(items) end
                        return wrapper
                    end
                    function ShimTab:Slider(opts)
                        local wrapper = { __opts = opts, Value = opts.Value }
                        function wrapper:Set(v) self.Value = v; if opts.Callback then pcall(opts.Callback, v) end end
                        return wrapper
                    end
                    function ShimTab:Colorpicker(opts) return { Set = function() end } end
                    function ShimTab:Keybind(opts) return { Set = function() end } end
                    function ShimTab:Code(opts) return self end
                    function ShimTab:UI() return self end

                    local ShimWindow = {}
                    function ShimWindow:Tab(opts) return setmetatable({ __opts = opts }, ShimTab) end
                    function ShimWindow:Section(opts) return ShimWindow end
                    function ShimWindow:Divider() return ShimWindow end
                    function ShimWindow:Dialog(opts) return { __opts = opts } end

                    local ShimWindUI = {}
                    function ShimWindUI:Notify(opts) end
                    function ShimWindUI:Popup(opts) return { __opts = opts } end
                    ShimWindUI.Icons = setmetatable({}, { __index = function() return "" end })

                    getgenv().Window = ShimWindow
                    getgenv().WindUI = ShimWindUI

    local wrapped = [==[
            return function(Window, WindUI, LocalPlayer, HttpService, isXeno)
                    if not isXeno then
                        local SkinTab = Window:Tab({ Title = "Unlock All", Icon = "box" })
                
                        local favoriteSwords = {}
                        pcall(function()
                            if isfile and isfile("LeviHubX/fav_swords.json") then
                                local decoded = HttpService:JSONDecode(readfile("LeviHubX/fav_swords.json"))
                                if type(decoded) == "table" then favoriteSwords = decoded end
                            end
                        end)
                        local function saveFavs()
                            pcall(function()
                                if isfolder and makefolder and not isfolder("LeviHubX") then makefolder("LeviHubX") end
                                if writefile then writefile("LeviHubX/fav_swords.json", HttpService:JSONEncode(favoriteSwords)) end
                            end)
                        end
                        local function refreshFavList() end
                        getgenv().setExplosionChangerToggleUI = function() end
                        getgenv().setExplosionInputUI = function() end
                        getgenv().setExplosionApplyText = function() end
                        getgenv().setLeviHubShopButtonText = function(button, text)
                        ...
                        getgenv().forceLeviHubShopEquippedText = function(shop, button, kind, itemName)
                            getgenv()._lhxShopForcedEquip = {
                                Button = button,
                                Kind = kind,
                                Name = itemName,
                                Until = os.clock() + 2.5,
                            ...
                            local function applyOnce()
                                ...
                                getgenv().setLeviHubShopButtonText(targetButton, "Equipped")
                            end
                
                            applyOnce()
                            task.spawn(function()
                                while os.clock() < getgenv()._lhxShopForcedEquip.Until do
                                    applyOnce()
                                    task.wait(0.05)
                                end
                            end)
                        ...
                        SkinTab:Section({ Title = "Unlock All" })
                        SkinTab:Toggle({
                            Title = "Unlock All",
                            Desc = "Unlocks sword and explosion shop pages locally",
                            Value = false,
                            Callback = function(v)
                                ...
                                if not shop then
                                    WindUI:Notify({ Title = "Error", Content = "Shop GUI not found!", Duration = 3 })
                                    return
                                end
                
                                if not getgenv().unlockAllHooked then
                                    getgenv()._lhxCurrentInfoItem = ""
                                    getgenv()._lhxCurrentInfoKind = ""
                                    getgenv().unlockAllHooked = true
                                    ...
                                    task.spawn(function()
                                        while task.wait(0.4) do
                                            local pages = shop.Holder and shop.Holder:FindFirstChild("Pages")
                                            if (shop.Enabled == false) or (shop.Holder and shop.Holder.Visible == false) then
                                                getgenv()._lhxCurrentInfoItem = ""
                                                getgenv()._lhxCurrentInfoKind = ""
                                            end
                                            getgenv()._lhxCurrentShopKind = ""
                                            if pages then
                                                for _, activePageName in ipairs({"Sword", "Explosion"}) do
                                                    local activePage = pages:FindFirstChild(activePageName)
                                                    if activePage and activePage:IsA("GuiObject") and activePage.Visible then
                                                        getgenv()._lhxCurrentShopKind = activePageName
                                                        break
                                                    end
                                                end
                                            end
                                            if (getgenv()._lhxCurrentShopKind or "") ~= ""
                                                and (getgenv()._lhxCurrentInfoKind or "") ~= ""
                                                and getgenv()._lhxCurrentInfoKind ~= getgenv()._lhxCurrentShopKind then
                                                getgenv()._lhxCurrentInfoItem = ""
                                                getgenv()._lhxCurrentInfoKind = ""
                                            end
                                                    ...
                                                    for _, child in ipairs(page:GetDescendants()) do
                                                        if child.Name == "Lock" and child:IsA("GuiObject") then
                                                            ...
                                                            if itemCard and itemCard:IsA("GuiObject") then
                                                                ...
                                                                if favBtn and favBtn:IsA("GuiObject") then favBtn.Visible = false end
                                                                if delBtn and delBtn:IsA("GuiObject") then delBtn.Visible = false end
                                                                ...
                                                                if not itemCard:FindFirstChild("LeviHubHooked") then
                                                                    ...
                                                                    local itemKind = pageName
                                                                    local titleObj = itemCard:FindFirstChild("Title", true) or itemCard:FindFirstChild("ItemName", true) or itemCard:FindFirstChild("Name", true)
                                                                    if titleObj and titleObj:IsA("TextLabel") then itemName = titleObj.Text end
                                                                    
                                                                    if not itemCard:FindFirstChild("LeviHubItemHook") then
                                                                        local tag = Instance.new("BoolValue", itemCard)
                                                                        tag.Name = "LeviHubItemHook"
                                                                        itemCard.InputEnded:Connect(function(input)
                                                                            if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                                                                                getgenv()._lhxCurrentInfoItem = itemName
                                                                                getgenv()._lhxCurrentInfoKind = itemKind
                                                                            end
                                                                        end)
                                                                    end
                                                                    ...
                                                                    if favBtn and (favBtn:IsA("GuiButton") or favBtn:IsA("ImageButton") or favBtn:IsA("TextButton")) then
                                                                        favBtn.MouseButton1Click:Connect(function()
                                                                            local found = false
                                                                            for _, s in ipairs(favoriteSwords) do if s == itemName then found = true; break end end
                                                                            if not found then
                                                                                table.insert(favoriteSwords, itemName)
                                                                                pcall(function() saveFavs() end)
                                                                                pcall(function() refreshFavList() end)
                                                                                WindUI:Notify({ Title = "Favorites", Content = itemName .. " added to favorites.", Duration = 3 })
                                                                            else
                                                                                WindUI:Notify({ Title = "Favorites", Content = itemName .. " is already in favorites.", Duration = 3 })
                                                                            end
                                                                        end)
                                                                    end
                                                                        ...
                                                                        delBtn.MouseButton1Click:Connect(function()
                                                                            ...
                                                                            for i, s in ipairs(favoriteSwords) do
                                                                                if s == itemName then
                                                                                    ...
                                                                                    pcall(function() saveFavs() end)
                                                                                    pcall(function() refreshFavList() end)
                                                                                    WindUI:Notify({ Title = "Favorites", Content = itemName .. " removed from favorites.", Duration = 3 })
                                                                                    removed = true
                                                                                    break
                                                                                end
                                                                            end
                                                                            if not removed then
                                                                                WindUI:Notify({ Title = "Favorites", Content = itemName .. " is not in favorites.", Duration = 3 })
                                                                            end
                                                                        end)
                                                                    end
                                                                end
                                            ...
                                            if infoBG then
                                                ...
                                                if targetBtn then
                                                    local function getSelectedShopItemName()
                                                        local clickedItem = getgenv()._lhxCurrentInfoItem or ""
                                                        local clickedKind = getgenv()._lhxCurrentInfoKind or ""
                                                        local activeKind = getgenv()._lhxCurrentShopKind or ""
                                                        if activeKind ~= "" and clickedKind ~= "" and clickedKind ~= activeKind then return "" end
                                                        if clickedItem == "" or clickedItem == "Title" then return "" end
                                                        local itemName = clickedItem
                                                        pcall(function()
                                                            local ibg = shop.Holder and shop.Holder:FindFirstChild("InfoBG")
                                                            local namer = ibg and ibg:FindFirstChild("Namer")
                                                            if namer and namer:IsA("TextLabel") and namer.Text ~= "" and namer.Text ~= "Title" then
                                                                itemName = namer.Text
                                                            end
                                                        end)
                                                        return itemName
                                                    end
                                                    local selectedShopItem = getSelectedShopItemName()
                                                    local hasSelectedShopItem = selectedShopItem ~= ""
                                                    targetBtn.Visible = hasSelectedShopItem
                                                    if targetBtn:IsA("GuiButton") then targetBtn.Active = hasSelectedShopItem end
                
                                                    local forcedEquip = getgenv()._lhxShopForcedEquip
                                                    local namerNow = ""
                                                    pcall(function()
                                                        local ibgN = shop.Holder:FindFirstChild("InfoBG")
                                                        local nmr = ibgN and ibgN:FindFirstChild("Namer")
                                                        if nmr and nmr:IsA("TextLabel") then namerNow = nmr.Text end
                                                    end)
                                                    local activeKindForButton = "Sword"
                                                    do
                                                        local okS2, isS2 = pcall(function()
                                                            local m = require(game:GetService("ReplicatedStorage").Shared.ReplicatedInstances.Swords)
                                                            return m:GetSword(namerNow) ~= nil
                                                        end)
                                                        if not (okS2 and isS2) then activeKindForButton = "Explosion" end
                                                    end
                                                    if hasSelectedShopItem and forcedEquip
                                                        and forcedEquip.Until
                                                        and os.clock() < forcedEquip.Until
                                                        and forcedEquip.Kind == activeKindForButton then
                                                        getgenv().setLeviHubShopButtonText(targetBtn, "Equipped")
                                                    else
                                                        local txt = targetBtn:FindFirstChildOfClass("TextLabel")
                                                        if txt and txt.Text ~= "Equip" and txt.Text ~= "Equipped" then txt.Text = "Equip" end
                                                        if targetBtn:IsA("TextButton") and targetBtn.Text ~= "Equip" and targetBtn.Text ~= "Equipped" then targetBtn.Text = "Equip" end
                                                    end
                
                                                    local globalFav = shop.Holder:FindFirstChild("Favorite", true) or shop:FindFirstChild("Favorite", true)
                                                    local infoBG_forDel = shop.Holder:FindFirstChild("InfoBG")
                                                    local globalDel = infoBG_forDel and infoBG_forDel:FindFirstChild("Delete") or shop.Holder:FindFirstChild("Delete", true)
                                                    
                                                    if globalFav then
                                                        globalFav.Visible = hasSelectedShopItem
                                                        if globalFav:IsA("GuiButton") then globalFav.Active = hasSelectedShopItem end
                                                    end
                                                    if globalDel then
                                                        globalDel.Visible = hasSelectedShopItem
                                                        if globalDel:IsA("GuiButton") then globalDel.Active = hasSelectedShopItem end
                                                    end
                
                                                    if not targetBtn:FindFirstChild("SkinChangerHookedV2") then
                                                         local hookTag = Instance.new("BoolValue", targetBtn)
                                                         hookTag.Name = "SkinChangerHookedV2"                                         
                                                         local globalFav = shop.Holder:FindFirstChild("Favorite", true) or shop:FindFirstChild("Favorite", true)
                                                         local infoBG_forDel = shop.Holder:FindFirstChild("InfoBG")
                                                         local globalDel = infoBG_forDel and infoBG_forDel:FindFirstChild("Delete") or shop.Holder:FindFirstChild("Delete", true)
                
                                                         local function getInfoItemName()
                                                    local clickedItem = getgenv()._lhxCurrentInfoItem or ""
                                                    local clickedKind = getgenv()._lhxCurrentInfoKind or ""
                                                    local activeKind = getgenv()._lhxCurrentShopKind or ""
                                                    if activeKind ~= "" and clickedKind ~= "" and clickedKind ~= activeKind then return "" end
                                                    if clickedItem == "" or clickedItem == "Title" then return "" end
                                                    local nm = clickedItem
                                                    pcall(function()
                                                        local ibg = shop.Holder:FindFirstChild("InfoBG")
                                                        local namer = ibg and ibg:FindFirstChild("Namer")
                                                        if namer and namer:IsA("TextLabel") and namer.Text ~= "" and namer.Text ~= "Title" then nm = namer.Text end
                                                    end)
                                                    return nm
                                                         end
                
                                                         if globalFav and not globalFav:FindFirstChild("LeviHubFavHooked") then
                                                             local favTag = Instance.new("BoolValue", globalFav)
                                                             favTag.Name = "LeviHubFavHooked"
                                                             globalFav.MouseButton1Click:Connect(function()
                                                                 local itemName = getInfoItemName()
                                                         ...
                                                         if globalDel and not globalDel:FindFirstChild("LeviHubDelHooked") then
                                                             local delTag = Instance.new("BoolValue", globalDel)
                                                             delTag.Name = "LeviHubDelHooked"
                                                             globalDel.MouseButton1Click:Connect(function()
                                                                 local itemName = getInfoItemName()
                                                                 if itemName ~= "" and itemName ~= "Title" then
                                                                     local removed = false
                                                                     for i, s in ipairs(favoriteSwords) do
                                                                         if s == itemName then
                                                                             table.remove(favoriteSwords, i)
                                                                             removed = true
                                                                             WindUI:Notify({ Title = "Favorites", Content = itemName .. " deleted from favorites.", Duration = 3 })
                                                                             break
                                                                         end
                                                                     end
                                                                     if not removed then
                                                    ...
                                                    local activeKind = "Sword"
                                                    do
                                                        local nmK = ""
                                                        pcall(function()
                                                            local ibgK = shop.Holder:FindFirstChild("InfoBG")
                                                            local nmr = ibgK and ibgK:FindFirstChild("Namer")
                                                            if nmr and nmr:IsA("TextLabel") then nmK = nmr.Text end
                                                        end)
                                                        if nmK == "" then nmK = getgenv()._lhxCurrentInfoItem or "" end
                                                        local okS, isS = pcall(function()
                                                            local m = require(game:GetService("ReplicatedStorage").Shared.ReplicatedInstances.Swords)
                                                            return m:GetSword(nmK) ~= nil
                                                        end)
                                                        if not (okS and isS) then activeKind = "Explosion" end
                                                    end
                                                            ...
                                                            if not infoBG then
                                                             ...
                                                             if itemName ~= "" and itemName ~= "Title" then
                                                                 getgenv().forceLeviHubShopEquippedText(shop, targetBtn, activeKind, itemName)
                
                                                                if activeKind == "Explosion" then
                                                                    getgenv().explosionFX = itemName
                                                                    getgenv().explosionChanger = true
                                                                    if getgenv().setExplosionChangerToggleUI then getgenv().setExplosionChangerToggleUI(true) end
                                                                    if getgenv().setExplosionInputUI then getgenv().setExplosionInputUI(itemName) end
                                                                    getgenv().setExplosionApplyText("Equipped")
                                                                    ...
                                                                    if getgenv().setSkinChangerToggleUI then getgenv().setSkinChangerToggleUI(true) end
                                                                    if skinSwordInput and skinSwordInput.Set then skinSwordInput:Set(itemName) end
                                    ...
                                    WindUI:Notify({ Title = "Skin Changer", Content = "Unlocked swords and explosions locally!", Duration = 3 })
                                else
                                    WindUI:Notify({ Title = "Skin Changer", Content = "Already unlocked!", Duration = 3 })
                                end
                            end,
                        })
                    ...
                    local runOk, runFn = pcall(loadstring, wrapped)
                    if not runOk or type(runFn) ~= "function" then
                        warn("[Unlock All] loadstring failed: " .. tostring(runFn))
                        return
                    end
                    local factoryOk, factory = pcall(runFn)
                    if not factoryOk or type(factory) ~= "function" then
                        warn("[Unlock All] factory call failed: " .. tostring(factory))
                        return
                    end
                    local execOk, execErr = pcall(factory, ShimWindow, ShimWindUI, LocalPlayer, HttpService, false)
                    if not execOk then
                        warn("[Unlock All] source execution failed: " .. tostring(execErr))
                        return
                    end

                    -- Auto-fire the "Unlock All" toggle registered by source
                    task.wait(0.5)
                    for _, opts in ipairs(pendingToggles) do
                        if opts.Title == "Unlock All" and opts.Callback then
                            pcall(opts.Callback, true)
                        end
                    end
                end)
                if not ok then
                    warn("[Unlock All] outer error: " .. tostring(err))
                    unlockAllStarted = false
                end
            end)
        end
    })
...
local custom_announcer_module = MiscTab:create_module({
    ...
    callback = function(value: boolean)
        ...
        if value then
            ...
            if winnerLabel then
                winnerLabel.Text = getgenv().AnnouncerText or 'discord.gg/eHplcm8'
            end
                    ...
                    if child.Name == 'Winner' then
                        child.Changed:Connect(function(property)
                            if property == 'Text' and getgenv().CustomAnnouncer then
                                child.Text = getgenv().AnnouncerText or 'discord.gg/eHplcm8'
                            end
                        end)
...
getgenv().ThemeBackground = getgenv().ThemeBackground or nil

local function apply_background_theme(assetId)
    local library_ui = CoreGui:FindFirstChild('eHplcm8')
    if not library_ui then return false end

    local container = library_ui:FindFirstChild('Container')
    if not container then return false end

    local handler = container:FindFirstChild('Handler')
    if not handler then return false end

    local existing = handler:FindFirstChild('ThemeBackgroundImage')
...
-- ═══════════════════════════════════════════════════════════════════
-- CUSTOMIZATION PERSISTENCE SYSTEM
-- Auto-saves theme preset, custom asset ID, and RGB colors
-- Auto-loads on script start (survives quit/rejoin)
-- ═══════════════════════════════════════════════════════════════════

local CUSTOMIZATION_SAVE_PATH = "eHplcm8_customization.json"

local function customization_save()
    local ok = pcall(function()
        if not writefile then return end
        local data = {
            ThemeSelectedPreset = getgenv().ThemeSelectedPreset,
            ThemeBackground = getgenv().ThemeBackground,
            ThemeBackgroundInput = getgenv().ThemeBackgroundInput,
            UIColorR = getgenv().UIColorR,
            UIColorG = getgenv().UIColorG,
            UIColorB = getgenv().UIColorB,
        }
        local HS = cloneref and cloneref(game:GetService("HttpService")) or game:GetService("HttpService")
        local json = HS:JSONEncode(data)
        writefile(CUSTOMIZATION_SAVE_PATH, json)
    end)
end

local function customization_load()
    local loaded = nil
    pcall(function()
        if not isfile or not readfile then return end
        if not isfile(CUSTOMIZATION_SAVE_PATH) then return end
        local raw = readfile(CUSTOMIZATION_SAVE_PATH)
        if not raw or raw == "" then return end
        local HS = cloneref and cloneref(game:GetService("HttpService")) or game:GetService("HttpService")
        local data = HS:JSONDecode(raw)
        if type(data) == "table" then loaded = data end
    end)

    if not loaded then return end

    if loaded.ThemeSelectedPreset then getgenv().ThemeSelectedPreset = loaded.ThemeSelectedPreset end
    if loaded.ThemeBackground then getgenv().ThemeBackground = loaded.ThemeBackground end
    if loaded.ThemeBackgroundInput then getgenv().ThemeBackgroundInput = loaded.ThemeBackgroundInput end
    if type(loaded.UIColorR) == "number" then getgenv().UIColorR = loaded.UIColorR end
    if type(loaded.UIColorG) == "number" then getgenv().UIColorG = loaded.UIColorG end
    if type(loaded.UIColorB) == "number" then getgenv().UIColorB = loaded.UIColorB end
end

-- Load saved customization BEFORE UI creation
customization_load()


local ThemePresets = {
    ['Preset 1'] = '94410135585905',
    ['Preset 2'] = '129052568968415',
    ['Preset 3'] = '102845947790119',
    ['Preset 4'] = '93071197450197',
}
local ThemePresetOptions = { 'Preset 1', 'Preset 2', 'Preset 3', 'Preset 4' }

getgenv().ThemeSelectedPreset = getgenv().ThemeSelectedPreset or 'Preset 1'

local select_theme_module = ThemeTab:create_module({
    title = "Select Theme",
    description = "Choose a preset theme",
    flag = "SelectThemeModule",
    section = "left",
})

select_theme_module:create_dropdown({
    title = 'Theme Preset',
    flag = 'theme_preset',
    options = ThemePresetOptions,
    multi_dropdown = false,
    maximum_options = #ThemePresetOptions,
    callback = function(value)
        getgenv().ThemeSelectedPreset = value
        customization_save()
    end
})

select_theme_module:create_button({
    title = 'Save',
    callback = function()
        local preset = getgenv().ThemeSelectedPreset
        local id = preset and ThemePresets[preset]

        if id then
            getgenv().ThemeBackground = id
            customization_save()
            local ok = apply_background_theme(id)
            if ok then
                send_notification('Theme', preset .. ' applied', 2)
            else
                send_notification('Theme', 'Failed to apply', 2)
            end
        else
            send_notification('Theme', 'Please select a preset first', 2)
        end
    end
})

local theme_module = ThemeTab:create_module({
    title = "Background Theme",
    description = "Change background using Roblox asset ID",
    flag = "ThemeBackgroundModule",
    section = "right",
})

theme_module:create_textbox({
    title = 'Background Asset ID',
    placeholder = 'Enter Asset ID',
    flag = 'theme_bg_asset_id',
    callback = function(text)
        getgenv().ThemeBackgroundInput = text
        customization_save()
    end
})

theme_module:create_button({
    title = 'Apply Theme',
    callback = function()
        local id = getgenv().ThemeBackgroundInput

        if id and tostring(id):gsub('%s', '') ~= '' then
            local cleanId = tostring(id):gsub('%s', '')
            getgenv().ThemeBackground = cleanId
            customization_save()
            local ok = apply_background_theme(cleanId)
            if ok then
                send_notification('Theme', 'Background applied', 2)
            else
                send_notification('Theme', 'Failed to apply', 2)
            end
        else
            send_notification('Theme', 'Please enter an Asset ID', 2)
        end
    end
})
...
theme_module:create_button({
    title = 'Default',
    callback = function()
        getgenv().ThemeBackground = nil
        customization_save()
        apply_background_theme(nil)
        send_notification('Theme', 'Reverted to default', 2)
    end
})

getgenv().UIColorR = getgenv().UIColorR or 0
getgenv().UIColorG = getgenv().UIColorG or 0
getgenv().UIColorB = getgenv().UIColorB or 0

local function apply_ui_color(r, g, b)
    local library_ui = CoreGui:FindFirstChild('eHplcm8')
    if not library_ui then return false end
    ...
    local handlerColor = Color3.fromRGB(math.max(0, r - 10), math.max(0, g - 10), math.max(0, b - 10))
    local tabsColor = Color3.fromRGB(math.min(255, r + 12), math.min(255, g + 12), math.min(255, b + 14))
    local sectionColor = Color3.fromRGB(math.min(255, r + 15), math.min(255, g + 15), math.min(255, b + 18))
    local moduleColor = Color3.fromRGB(math.min(255, r + 20), math.min(255, g + 20), math.min(255, b + 22))
    local tabButtonColor = Color3.fromRGB(math.min(255, r + 25), math.min(255, g + 25), math.min(255, b + 25))

    pcall(function() container.BackgroundColor3 = baseColor end)
    pcall(function() handler.BackgroundColor3 = handlerColor end)

    local tabs = handler:FindFirstChild('Tabs')
    if tabs then
        pcall(function() tabs.BackgroundColor3 = tabsColor end)
        for _, tabObj in ipairs(tabs:GetChildren()) do
            if tabObj:IsA('TextButton') and tabObj.Name == 'Tab' then
                pcall(function() tabObj.BackgroundColor3 = tabButtonColor end)
            end
        end
    end

    local sections = handler:FindFirstChild('Sections')
    if sections then
        for _, sec in ipairs(sections:GetChildren()) do
            if sec.Name == 'LeftSection' or sec.Name == 'RightSection' then
                pcall(function() sec.BackgroundColor3 = sectionColor end)
                for _, mod in ipairs(sec:GetChildren()) do
                    if mod:IsA('Frame') then
                        pcall(function() mod.BackgroundColor3 = moduleColor end)
                    end
                end
            end
        end
...
local color_picker_module = ThemeTab:create_module({
    title = "Color Picker",
    description = "Customize UI background color (RGB)",
    flag = "ColorPickerModule",
    section = "left",
})

color_picker_module:create_slider({
    title = 'Red',
    flag = 'ui_color_r',
    minimum_value = 0,
    maximum_value = 255,
    value = getgenv().UIColorR,
    round_number = true,
    callback = function(value)
        getgenv().UIColorR = value
        apply_ui_color(getgenv().UIColorR, getgenv().UIColorG, getgenv().UIColorB)
        customization_save()
    end
})
...
color_picker_module:create_slider({
    ...
    minimum_value = 0,
    maximum_value = 255,
    value = getgenv().UIColorG,
    round_number = true,
    callback = function(value)
        getgenv().UIColorG = value
        apply_ui_color(getgenv().UIColorR, getgenv().UIColorG, getgenv().UIColorB)
        customization_save()
    end
})
...
color_picker_module:create_slider({
    ...
    minimum_value = 0,
    maximum_value = 255,
    value = getgenv().UIColorB,
    round_number = true,
    callback = function(value)
        getgenv().UIColorB = value
        apply_ui_color(getgenv().UIColorR, getgenv().UIColorG, getgenv().UIColorB)
        customization_save()
    end
})

color_picker_module:create_button({
    title = 'Reset to Black',
    callback = function()
        getgenv().UIColorR = 0
        getgenv().UIColorG = 0
        getgenv().UIColorB = 0
        apply_ui_color(0, 0, 0)
        customization_save()
        send_notification('Color Picker', 'Reset to default black', 2)
    end
})

local ShimmerColor = ColorSequence.new({
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(160, 160, 160)),
    ColorSequenceKeypoint.new(0.45, Color3.fromRGB(255, 255, 255)),
    ColorSequenceKeypoint.new(0.55, Color3.fromRGB(255, 255, 255)),
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(160, 160, 160))
...
local function force_shimmer_color(gradient)
    if not gradient or not gradient.Parent then return end
    pcall(function()
        gradient.Color = ShimmerColor
    end)
end
...
task.spawn(function()
    ...
    local function get_tab_gradients()
        local list = {}
        local library_ui = CoreGui:FindFirstChild('eHplcm8')
        if not library_ui then return list end
        local container = library_ui:FindFirstChild('Container')
        if not container then return list end
        local handler = container:FindFirstChild('Handler')
        if not handler then return list end
        local tabs = handler:FindFirstChild('Tabs')
        ...
        for _, tabObj in ipairs(tabs:GetChildren()) do
            if tabObj:IsA('TextButton') and tabObj.Name == 'Tab' then
                local textLabel = tabObj:FindFirstChild('TextLabel')
                local grad = textLabel and textLabel:FindFirstChildOfClass('UIGradient')
                if grad then
                    table.insert(list, grad)
                end
            end
        end
        return list
    ...
    for _, grad in ipairs(get_tab_gradients()) do
        force_shimmer_color(grad)
        pcall(function() grad.Offset = Vector2.new(-1, 0) end)
    end

    task.spawn(function()
        while true do
            local grads = get_tab_gradients()
            if #grads == 0 then
                task.wait(0.5)
            else
...
-- Auto-apply saved customization on script load
task.spawn(function()
    task.wait(1)
    pcall(function()
        -- Apply saved background theme
        if getgenv().ThemeBackground and apply_background_theme then
            apply_background_theme(getgenv().ThemeBackground)
        end
        -- Apply saved UI color
        if apply_ui_color and (getgenv().UIColorR ~= 0 or getgenv().UIColorG ~= 0 or getgenv().UIColorB ~= 0) then
            apply_ui_color(getgenv().UIColorR or 0, getgenv().UIColorG or 0, getgenv().UIColorB or 0)
        end
    end)
end)
...
-- ═══════════════════════════════════════════════════════════════════
-- LIMITLESS TAB — INFINITY MODULE (Light Support v4)
-- Auto-tunes with main autoparry accuracy
-- Zero interference with autoparry + autospam
-- Persistent shield + highlight (survives rounds/respawns)
-- ═══════════════════════════════════════════════════════════════════
...
task.spawn(function()
    ...
    local ok, err = pcall(function()
        ...
        if not library or not library.create_tab then
            warn("[INFINITY v4] library not found, skipping")
            return
        end

        local LimitlessTab = library:create_tab("Limitless")

        -- ═══════════════════════════════════════════════════════════════════
        -- INFINITY MODULE (Pure Support Refactor)
        -- 1. Fallback parry — mag-fires LANG kapag failed both autoparry + autospam
        -- 2. Gentle push — kapag lumalapit yung ball, konting push palayo para may buffer time
        --    yung autoparry/autospam mag-react bago tumama
        -- ═══════════════════════════════════════════════════════════════════
        -- INFINITY MODULE (Light Support — Fixed, No Sliders)
        -- 1. Push palayo (brutal) — para may buffer time yung autoparry/autospam
        -- 2. Silent fallback — mag-fire LANG kapag talagang failed na ang main
        --    (ball < 2 studs at walang main activity for 500ms straight)
        -- ═══════════════════════════════════════════════════════════════════
        -- INFINITY MODULE (Light Support — Adaptive Push)
        -- 1. Push palayo (brutal + adaptive) — mag-scale sa bilis ng bola
        -- 2. Silent fallback — mag-fire LANG kapag talagang failed na ang main
        -- ═══════════════════════════════════════════════════════════════════

        -- FIXED CONSTANTS (walang tuner)
        local INF_PUSH_TRIGGER_RANGE = 15
        local INF_PUSH_STRENGTH_MULT = 5.0
        local INF_PUSH_MIN_SPEED = 150
        local INF_PUSH_MAX_SPEED = 1200
        local INF_PUSH_SMOOTHNESS = 0.85

        -- ADAPTIVE PUSH CONSTANTS
        local INF_ADAPT_ENABLED = true            -- adaptive scaling based sa ball speed history
        local INF_ADAPT_HISTORY_WINDOW = 5.0      -- 5s rolling window of observed ball speeds
        local INF_ADAPT_SCALE_MIN = 1.0           -- baseline scale sa mabagal na ball
        local INF_ADAPT_SCALE_MAX = 2.5           -- max scale multiplier (up to 4x pag sobrang bilis)
        local INF_ADAPT_SPEED_FLOOR = 100         -- speed below this = 1x scale
        local INF_ADAPT_SPEED_CEILING = 800       -- speed at or above this = max scale
        local INF_ADAPT_MAX_ABS_CAP = 2500        -- absolute max push velocity kahit ano

        -- Fallback: sobrang strict para hindi mag-conflict
        local INF_FALLBACK_RANGE = 2.5
        local INF_FALLBACK_TIMEOUT = 0.5
        local INF_FIRE_COOLDOWN = 1.0
        local INF_MAIN_QUIET_WINDOW = 0.5

        local InfState = {
            enabled = false,
            push_enabled = true,           -- toggle-controlled
            loop_conn = nil,
            char_added_conn = nil,
            ...
            last_main_parry = 0,
            ball_first_seen = {},
            push_ball_last_pos = nil,
            push_ball_last_time = 0,
            -- Adaptive tracking
            observed_speeds = {},          -- list of { time, speed } entries
            peak_speed_seen = 0,
        }
        ...
        local function ensure_shield()
            ...
            for _, obj in ipairs(char:GetChildren()) do
                if obj:IsA("ForceField") and obj.Name == "InfinityShield" then
                    if obj.Parent then hasFF = true end
                end
                if obj:IsA("Highlight") and obj.Name == "InfinityHighlight" then
                    if obj.Parent then hasHL = true end
                end
            end
            ...
            if not hasHL then
                pcall(function()
                    ...
                    h.Name = "InfinityHighlight"
                    h.FillColor = Color3.fromRGB(0, 150, 255)
                    h.OutlineColor = Color3.fromRGB(80, 220, 255)
        ...
        local function remove_shield()
            local char = get_char()
            if char then
                for _, obj in ipairs(char:GetChildren()) do
                    if (obj:IsA("ForceField") and obj.Name == "InfinityShield")
                        or (obj:IsA("Highlight") and obj.Name == "InfinityHighlight") then
        ...
        -- Reset adaptive tracking (called kapag may namatay o nag-respawn)
        local function reset_adaptive_tracking()
            InfState.observed_speeds = {}
            InfState.peak_speed_seen = 0
        end

        -- Track observed ball speed history
        local function record_ball_speed(speed)
            local now = tick()
            table.insert(InfState.observed_speeds, { t = now, s = speed })
            -- Prune old entries beyond window
            local cutoff = now - INF_ADAPT_HISTORY_WINDOW
            while #InfState.observed_speeds > 0 and InfState.observed_speeds[1].t < cutoff do
                table.remove(InfState.observed_speeds, 1)
            end
            -- Track peak speed
            if speed > InfState.peak_speed_seen then
                InfState.peak_speed_seen = speed
            end
        end

        -- Get effective adaptive scale (0-4x multiplier based sa recent + peak)
        local function get_adaptive_scale(current_speed)
            if not INF_ADAPT_ENABLED then return 1.0 end
            -- Use max of current speed at peak seen sa window
            local referenceSpeed = math.max(current_speed, InfState.peak_speed_seen)
            if referenceSpeed <= INF_ADAPT_SPEED_FLOOR then
                return INF_ADAPT_SCALE_MIN
            end
            if referenceSpeed >= INF_ADAPT_SPEED_CEILING then
                return INF_ADAPT_SCALE_MAX
            end
            -- Linear interpolation between floor at ceiling
            local t = (referenceSpeed - INF_ADAPT_SPEED_FLOOR) / (INF_ADAPT_SPEED_CEILING - INF_ADAPT_SPEED_FLOOR)
            return INF_ADAPT_SCALE_MIN + (t * (INF_ADAPT_SCALE_MAX - INF_ADAPT_SCALE_MIN))
        end

        local function fire_fallback_parry()
            if not _PARRY_PATCH or not _PARRY_PATCH.ready then return end

            local now = tick()
            if now - InfState.last_fire < INF_FIRE_COOLDOWN then return end

            if System and System.__properties and System.__properties.__parried then
                InfState.last_main_parry = now
                return
            end
            if (now - InfState.last_main_parry) < INF_MAIN_QUIET_WINDOW then
                return
            end

            InfState.last_fire = now
            ...
            if alive then
                for _, entity in pairs(alive:GetChildren()) do
                    if entity.PrimaryPart then
                        pcall(function()
                            screenPositions[entity.Name] = camera:WorldToScreenPoint(entity.PrimaryPart.Position)
                        end)
                    end
                end
            end
            ...
            if System and System.curve and System.curve.get_cframe then
                pcall(function()
                    local r = System.curve.get_cframe()
                    if r then curveCF = r end
                end)
            end
            ...
            if is_mobile then
                ...
                local mOk, m = pcall(function() return UserInputService:GetMouseLocation() end)
                if mOk and m then
                    mouseLocation = { m.X, m.Y }
                else
                    local vp = camera.ViewportSize
                    mouseLocation = { vp.X / 2, vp.Y / 2 }
                end
        ...
        local function inf_get_ball_speed(ball)
            local speed = 0
            pcall(function()
            ...
            if speed < 0.1 then
                local now = tick()
                if InfState.push_ball_last_pos and InfState.push_ball_last_time > 0 then
                    local dt = now - InfState.push_ball_last_time
                    if dt > 0 and dt < 1 then
                        local diff = ball.Position - InfState.push_ball_last_pos
                        local flatDiff = Vector3.new(diff.X, 0, diff.Z)
                        speed = flatDiff.Magnitude / dt
                    end
                end
                InfState.push_ball_last_pos = ball.Position
                InfState.push_ball_last_time = now
            else
                InfState.push_ball_last_pos = ball.Position
                InfState.push_ball_last_time = tick()
            end
            return speed
        end

        local function apply_push(hrp, ball, dist)
            if not InfState.push_enabled then return end
            if dist > INF_PUSH_TRIGGER_RANGE then return end

            local diff = hrp.Position - ball.Position
            local flatDiff = Vector3.new(diff.X, 0, diff.Z)
            if flatDiff.Magnitude < 0.1 then return end

            local pushDir = flatDiff.Unit
            local ballSpeed = inf_get_ball_speed(ball)

            -- Record for adaptive tracking
            record_ball_speed(ballSpeed)

            -- Base velocity from ball speed
            local baseSpeed = math.max(ballSpeed * INF_PUSH_STRENGTH_MULT, INF_PUSH_MIN_SPEED)
            baseSpeed = math.min(baseSpeed, INF_PUSH_MAX_SPEED)

            -- Proximity boost
            local proximity = 1 - (dist / INF_PUSH_TRIGGER_RANGE)
            local proximityBoost = 1 + (proximity * 1.2)

            -- ADAPTIVE SCALE — mabilis ang ball = mas malakas push
            local adaptScale = get_adaptive_scale(ballSpeed)

            local finalSpeed = baseSpeed * proximityBoost * adaptScale

            -- Absolute cap para hindi mag-teleport out of map
            finalSpeed = math.min(finalSpeed, INF_ADAPT_MAX_ABS_CAP)

            local targetVel = pushDir * finalSpeed
            local currentVel = hrp.AssemblyLinearVelocity
            local currentFlat = Vector3.new(currentVel.X, 0, currentVel.Z)
            local newFlat = currentFlat:Lerp(targetVel, INF_PUSH_SMOOTHNESS)

            -- Pure velocity push
            pcall(function()
                hrp.AssemblyLinearVelocity = Vector3.new(newFlat.X, currentVel.Y, newFlat.Z)
            end)
        end

        -- Watch for deaths sa server para i-reset adaptive tracking
        local function setup_death_watcher()
            local alive = workspace:FindFirstChild("Alive")
            if not alive then return end
            if InfState.char_died_conn then InfState.char_died_conn:Disconnect() end
            InfState.char_died_conn = alive.ChildRemoved:Connect(function()
                -- Someone died — ball speed resets sa game, so reset natin din tracking
                reset_adaptive_tracking()
            end)
        end

        local function loop_step()
            if not InfState.enabled then return end
            ...
            if System and System.__properties then
                if System.__properties.__parried then
                    InfState.last_main_parry = tick()
                end
            end

            local ball = get_targeting_ball()
            if not ball then
                InfState.ball_first_seen = {}
                return
            end
            ...
            apply_push(hrp, ball, dist)

            -- Fallback logic
            if dist > INF_FALLBACK_RANGE then
                InfState.ball_first_seen[ball] = nil
                return
            end
            ...
            if not InfState.ball_first_seen[ball] then
                InfState.ball_first_seen[ball] = now
                return
            end

            local timeSince = now - InfState.ball_first_seen[ball]

            if timeSince < INF_FALLBACK_TIMEOUT then
                return
            end
        ...
        local function inf_start()
            InfState.enabled = true
            reset_adaptive_tracking()
            ensure_shield()

            if InfState.char_added_conn then InfState.char_added_conn:Disconnect() end
            InfState.char_added_conn = Players.LocalPlayer.CharacterAdded:Connect(function()
                task.wait(0.2)
                if InfState.enabled then
                    reset_adaptive_tracking()
                    for i = 1, 15 do
                        if not InfState.enabled then break end
                        ensure_shield()
                        task.wait(0.3)
                    end
                end
            ...
            if InfState.char_removing_conn then InfState.char_removing_conn:Disconnect() end
            InfState.char_removing_conn = Players.LocalPlayer.CharacterRemoving:Connect(function()
                InfState.ball_first_seen = {}
                reset_adaptive_tracking()
            end)
            ...
            if InfState.loop_conn then InfState.loop_conn:Disconnect() end
            InfState.loop_conn = RunService.Heartbeat:Connect(loop_step)
        end

        local function inf_stop()
            InfState.enabled = false
            if InfState.loop_conn then InfState.loop_conn:Disconnect() InfState.loop_conn = nil end
            if InfState.char_added_conn then InfState.char_added_conn:Disconnect() InfState.char_added_conn = nil end
            if InfState.char_removing_conn then InfState.char_removing_conn:Disconnect() InfState.char_removing_conn = nil end
            if InfState.char_died_conn then InfState.char_died_conn:Disconnect() InfState.char_died_conn = nil end
            InfState.ball_first_seen = {}
            reset_adaptive_tracking()
            remove_shield()
        end

        local infinity_module = LimitlessTab:create_module({
            title = "Infinity",
            description = "Light support",
            flag = "Infinity_Enabled",
            section = "left",
            callback = function(state)
                if state then inf_start() else inf_stop() end
            end
        })

        infinity_module:create_checkbox({
            title = "Enable Push",
            flag = "Infinity_PushEnabled",
            callback = function(value)
                InfState.push_enabled = value
            end
        })

        -- Default push ON
        InfState.push_enabled = true
    ...
    if not ok then
        warn("[INFINITY v4] Failed to load: " .. tostring(err))
    end
end)
